...
const RestaurantsPage = () => {
  ...
  useEffect(() => {
    const fetchCountRestaurants = async () => {
      try {
        ...
        console.error("Error while count restaurants: ", error);
      }
    };
  ...
  const deleteRecord = async (id: number) => {
    try {
      ...
      console.error("Error while delete restaurant: ", error);
    }
  };
  ...
  return (
    <section>
      ...
      <div className="overflow-x-scroll">
        <table className="w-full table-auto rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark min-w-203">
