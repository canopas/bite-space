...
const ResetPassword = () => {
  ...
  const verifyGivenToken = async () => {
    try {
      const email = await fetchEmailFromToken(token as string);
  ...
  useEffect(() => {
    const verifyGivenToken = async () => {
      try {
        ...
        console.error("Error while verify given token: ", error);
      }
    };
          ...
          <div className="text-center">
            ...
            >
              ...
              <div className="mb-5 w-96">
                <button
                  type="submit"
                  className={`w-full rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90 disabled:opacity-30 ${
                    isLoading
