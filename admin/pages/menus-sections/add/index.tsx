...
const AddMenusSectionPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchOptionsData = async () => {
      try {
        ...
        console.error("Error while fetch menu options: ", error);
      }
    };
  ...
  const handleAddMenusSection = async (e: any) => {
    e.preventDefault();
    ...
    try {
      ...
      const { error } = await supabase.from("menus_sections").insert({
      ...
      console.error("Error while saving menus section: ", error);
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <section>
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <form
          ...
          onSubmit={handleAddMenusSection}
        >
          <div>
...
export default AddMenusSectionPage;
