...
const PendingInvitationsPage = () => {
  ...
  const fetchPendingInvitations = async (page: number) => {
    try {
      ...
      console.error("Error while fetching pending invitations: ", error);
    }
  };
  ...
  const fetchCountPendingInvitations = async () => {
    try {
      ...
      console.error("Error while count pending invitations: ", error);
    }
  };
  ...
  const acceptInvitation = async (
    ...
    try {
      ...
      console.error("Error while accept invitation: ", error);
    }
  };
  ...
  const rejectInvitation = async (id: number) => {
    try {
      ...
      console.error("Error while reject invitation: ", error);
    }
  };
  ...
  return (
    <section>
      ...
      <div className="overflow-x-scroll">
        <table className="w-full rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark min-w-203">
