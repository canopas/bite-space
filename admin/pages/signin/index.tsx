  ...
  const handleSignIn = async (e: any) => {
    ...
    try {
      ...
      if (decrypted !== password) {
        setErrors([{ for: "password", message: "Password do not matched" }]);
        return;
      }
      ...
      setError({ message: "Please try again by using correct email" });
    ...
    <section>
      <div className="h-screen rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex h-full divide-x ">
          <div className="hidden h-full w-full items-center lg:flex lg:w-1/2">
            <div className="px-26 py-17.5 text-center">
              ...
              <p className="2xl:px-20">
                ...
                passion meets the palate – Welcome to a world of culinary
                delight!
              </p>
          ...
          <div className="h-full w-full border-stroke dark:border-strokedark lg:w-1/2">
            {isShowError ? (
            ...
            <div className="flex h-full w-full flex-col justify-center p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block">Start for free</span>
