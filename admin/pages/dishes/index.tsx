...
const DishesPage = () => {
  ...
  const fetchDishes = async (page: number) => {
    ...
    try {
      ...
      console.error("Error while fetching dishes data: ", error);
    }
  };
  ...
  const deleteRecord = async (id: number) => {
    try {
      ...
      console.error("Error while delete dish", error);
    }
  };
    ...
    <section>
      ...
      {!isDataLoading && !restaurantId ? (
        ...
        <div className="overflow-x-scroll">
          <table className="w-full table-auto rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark min-w-230">
